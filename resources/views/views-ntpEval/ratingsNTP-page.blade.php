        ...
        <div class="card-body">
            ...
            @foreach($evaluation->tool->items as $item)
                ...
                @if($item->criterion->isNotEmpty())
                    <tr>
                        <td class="col-md-4 statement pl-2" id="stmt-id">&nbsp;&nbsp;&nbsp;{{$item->statement}}</td>
                    @foreach($item->criterion as $criterion)
                    <!-- <td><input type="text" name=""  value="">{{$criterion->criterion}}</td> -->
                        <td>
                            <p style="margin-bottom: 0;">{{$criterion->criterion}}</p>
